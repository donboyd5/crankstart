...
-   Present selected data provided by the Department of Children, Youth & Their Families (DCYF) from its internal systems, to illustrate the kinds of additional information that may be available from agency-by-agency requests.
...
![](images\tab_topdepts.png){ width=100% }
...
![](images\tab_topnpes.png){ width=100% }


## NonProfit Organizations With Largest Grant Payments, by Department
...
![](images\tab_topnpe_bydept.png){height=100% width=95% }
:::
\elandscape
...
### Department of Children, Youth, & Families Data
